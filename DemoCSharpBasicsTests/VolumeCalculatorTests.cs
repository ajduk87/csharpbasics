...
namespace DemoCSharpBasicsTests
{
    public class VolumeCalculatorTests
    {
        ...
        public void CubeVolumeTest()
        {
            //Arange
            double a = 2;
            Cube plasticCube = new Cube(name: "cube", a: 2, Material.PLASTIC, price: 8, SpecificMaterial.PINEWOOD);
        ...
        public void CylinderVolumeTest()
        {
            ...
            double r = 2;
            double H = 2;
            Cylinder plasticCylinder = new Cylinder(name: "cylinder", r: 2, H: 3, Material.PLASTIC, price: 10, SpecificMaterial.PINEWOOD);
        ...
        public void SphereVolumeTest()
        {
            //Arange
            double r = 2;
            Sphere plastricSphere = new Sphere(name: "sphere", r: 2, Material.PLASTIC, price: 6, SpecificMaterial.PINEWOOD);
