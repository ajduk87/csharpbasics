...
namespace DemoCSharpBasicsTests
{
    public class VolumeCalculatorTests
    {
        ...
        public void CubeVolumeTest()
        {
            //Arange
            double a = 2;
            Cube plasticCube = new Cube(name: "cube", a: 2, Material.PLASTIC, price: 8, amount: 6);
        ...
        public void SphereVolumeTest()
        {
            //Arange
            double r = 2;
            Sphere plastricSphere = new Sphere(name: "sphere", r: 2, Material.PLASTIC, price: 6, amount: 6);
